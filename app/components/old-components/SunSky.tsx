...
// Preetham Sky Shader Implementation
const skyShader = {
  uniforms: {
...
export default function SunSky() {
  ...
  useEffect(() => {
    ...
    // 2. Setup Sun Position
    const sun = new THREE.Vector3();
    const elevation = 2; // Tweaking this changes sunset/sunrise feel
    const azimuth = 180; // Sun direction
    ...
    // 3. Generate Scene Environment Reflection using PMREMGenerator
